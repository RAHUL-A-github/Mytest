 ...
 TextEditingController nameController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //                       Text("E-mail: ${data['email']}",style: TextStyle(fontSize: 14.0,fontWeight: FontWeight.bold)),
      //                       Text("mob:${data['mobile_number']}",style: TextStyle(fontSize: 14.0,fontWeight: FontWeight.bold)),
      //                     ],
      //                   ),
      //                 ),
      //               ],
